...
# group by symbol and window_end, collect window statistics into a list
grouped_df = union_df.groupBy("symbol", "window_end").agg(
...
# write out the stream as JSON to console
"""writer = (output_df.select("value").writeStream
    .outputMode("update")
    .format("console")
